public class GenericMapImpl implements SimpleMap {
	...
	// Creates Stack Node of type T and inserts into corresponding list for key value
	public static <T> void put(int key, <T> name) {
	...
	*/
	...
	public static <T> void remove(int key, <T> name) {
